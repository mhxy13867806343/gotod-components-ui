            ...
            <div style="background:linear-gradient(135deg, rgba(64,158,255,0.1), rgba(103,194,58,0.1)); border:1px solid var(--primary); padding:14px; border-radius:8px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
              <div>
                <div style="font-weight:800; font-size:13px; color:var(--primary); display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-box-archive"></i> gotod-components-ui v1.6.4 独立安装包 (.zip)
              ...
              <div style="display:flex; gap:8px; flex-wrap:wrap;">
                <a href="https://github.com/mhxy13867806343/gotod-components-ui/releases/download/v1.6.4/gotod-components-ui-v1.6.4.zip" class="g-btn g-btn-primary" style="height:32px; font-size:12px; font-weight:700;">
                  <i class="fa-solid fa-download"></i> 立即下载 gotod-components-ui-v1.6.4.zip
                </a>
...
# 下载直链: https://github.com/mhxy13867806343/gotod-components-ui/releases/download/v1.6.4/gotod-components-ui-v1.6.4.zip
