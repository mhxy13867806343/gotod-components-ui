  ...
  "methods": [
    {
      ...
      "desc": "静态多态构建工厂方法。支持单图标名参数、字典配置对象、多参数位置传递三种形态",
