window.COMPONENT_CATALOG = {
  ...
  "input-number": {
    ...
    "demos": [
      {
        "title": "1. 基础数字输入 (Basic Number Input)",
        "render": "<div style=\"display:flex; align-items:center; gap:8px;\"><button class=\"g-btn g-btn-default\" style=\"padding:4px 10px;\" onclick=\"const el=this.nextElementSibling; el.value = Math.max(0, parseInt(el.value||0)-1);\">-</button><input type=\"number\" class=\"g-input\" value=\"1\" min=\"1\" max=\"99\" style=\"width:60px; text-align:center;\"><button class=\"g-btn g-btn-default\" style=\"padding:4px 10px;\" onclick=\"const el=this.previousElementSibling; el.value = Math.min(99, parseInt(el.value||0)+1);\">+</button></div>",
        "code": "# GDScript: 基础数字输入\nvar num_input = GInputNumber.new()\nnum_input.value = 1\nadd_child(num_input)"
      },
      {
        "title": "2. 步长与精度控制 (Step & Precision: 0.1 / 0.01)",
        "render": "<div style=\"display:flex; align-items:center; gap:8px;\"><input type=\"number\" class=\"g-input\" value=\"1.50\" step=\"0.25\" style=\"width:80px; text-align:center;\"><span style=\"font-size:12px; color:var(--text-secondary);\">步长: 0.25, 精度: 2 位小数</span></div>",
        "code": "# GDScript: 精度与步长\nnum_input.step = 0.25\nnum_input.precision = 2"
      },
      {
        "title": "3. 最大值与最小值限制 (Strict Range: 10 ~ 100)",
        "render": "<div style=\"display:flex; align-items:center; gap:8px;\"><input type=\"number\" class=\"g-input\" value=\"50\" min=\"10\" max=\"100\" style=\"width:70px; text-align:center;\"><span style=\"font-size:12px; color:var(--text-secondary);\">范围限定: [10, 100]</span></div>",
        "code": "# GDScript: 上下限\nnum_input.min_value = 10\nnum_input.max_value = 100"
      },
      {
        "title": "4. 控制按钮位置 (Controls Position: Right / Sides)",
        "render": "<div style=\"display:inline-flex; border:1px solid var(--border-base); border-radius:var(--radius-sm); overflow:hidden;\"><input type=\"number\" class=\"g-input\" value=\"8\" style=\"width:50px; border:none; text-align:center;\"><div style=\"display:flex; flex-direction:column; border-left:1px solid var(--border-base);\"><button style=\"border:none; background:none; cursor:pointer; font-size:9px; padding:2px 4px; border-bottom:1px solid var(--border-base);\">▲</button><button style=\"border:none; background:none; cursor:pointer; font-size:9px; padding:2px 4px;\">▼</button></div></div>",
        "code": "# GDScript: 右侧按钮\nnum_input.controls_position = GInputNumber.Controls.RIGHT"
      },
      {
        "title": "5. 游戏自由加点属性分配器 (RPG Stat Points Allocator)",
        "render": "<div style=\"max-width:320px; background:var(--bg-surface); padding:12px; border-radius:8px; border:1px solid var(--border-base); display:flex; flex-direction:column; gap:8px;\"><div style=\"display:flex; justify-content:space-between; font-size:12px;\"><span>剩余潜能点:</span><strong style=\"color:var(--primary);\">15 点</strong></div><div style=\"display:flex; justify-content:space-between; align-items:center; font-size:13px;\"><span>💪 力量属性:</span><div style=\"display:flex; gap:4px; align-items:center;\"><button class=\"g-btn g-btn-default\" style=\"padding:1px 6px;\">-</button><span style=\"width:30px; text-align:center; font-weight:600;\">28</span><button class=\"g-btn g-btn-primary\" style=\"padding:1px 6px;\">+</button></div></div></div>",
