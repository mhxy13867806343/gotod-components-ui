window.COMPONENT_CATALOG = {
  ...
  "input-number": {
    ...
    "demos": [
      {
        "title": "1. 基础数字输入 (Basic Number Input: 左右两侧按钮)",
        "render": "\n      <div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:6px; background:var(--bg-surface); overflow:hidden;\">\n        <button style=\"width:36px; height:36px; border:none; background:var(--bg-surface); color:var(--text-primary); cursor:pointer; font-size:16px; display:flex; align-items:center; justify-content:center; transition:background 0.2s;\" onmouseover=\"this.style.background='var(--primary)'; this.style.color='#fff';\" onmouseout=\"this.style.background='var(--bg-surface)'; this.style.color='var(--text-primary)';\" onclick=\"const el = document.getElementById('inDemo1'); el.value = Math.max(1, parseInt(el.value || 1) - 1);\">\n          <i class=\"fa-solid fa-minus\"></i>\n        </button>\n        <input type=\"text\" id=\"inDemo1\" value=\"1\" style=\"width:60px; height:36px; border:none; border-left:1px solid var(--border-base); border-right:1px solid var(--border-base); text-align:center; background:var(--bg-card); color:var(--text-primary); font-size:14px; font-weight:600; outline:none;\" onchange=\"this.value = Math.max(1, Math.min(99, parseInt(this.value)||1))\">\n        <button style=\"width:36px; height:36px; border:none; background:var(--bg-surface); color:var(--text-primary); cursor:pointer; font-size:16px; display:flex; align-items:center; justify-content:center; transition:background 0.2s;\" onmouseover=\"this.style.background='var(--primary)'; this.style.color='#fff';\" onmouseout=\"this.style.background='var(--bg-surface)'; this.style.color='var(--text-primary)';\" onclick=\"const el = document.getElementById('inDemo1'); el.value = Math.min(99, parseInt(el.value || 1) + 1);\">\n          <i class=\"fa-solid fa-plus\"></i>\n        </button>\n      </div>\n    ",
        "code": "# GDScript: 基础数字输入框\nvar num_input = GInputNumber.new()\nnum_input.value = 1\nnum_input.min_value = 1\nnum_input.max_value = 99\nadd_child(num_input)"
      },
      {
        "title": "2. 步长与精度控制 (Step: 0.25 & Precision: 2 位小数)",
        "render": "\n      <div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:6px; background:var(--bg-surface); overflow:hidden;\">\n        <button style=\"width:36px; height:36px; border:none; background:var(--bg-surface); color:var(--text-primary); cursor:pointer; font-size:14px; display:flex; align-items:center; justify-content:center;\" onmouseover=\"this.style.background='var(--primary)'; this.style.color='#fff';\" onmouseout=\"this.style.background='var(--bg-surface)'; this.style.color='var(--text-primary)';\" onclick=\"const el = document.getElementById('inDemo2'); el.value = (Math.max(0, parseFloat(el.value || 0) - 0.25)).toFixed(2);\">\n          <i class=\"fa-solid fa-minus\"></i>\n        </button>\n        <input type=\"text\" id=\"inDemo2\" value=\"1.50\" style=\"width:70px; height:36px; border:none; border-left:1px solid var(--border-base); border-right:1px solid var(--border-base); text-align:center; background:var(--bg-card); color:var(--text-primary); font-size:13px; font-weight:600; outline:none;\">\n        <button style=\"width:36px; height:36px; border:none; background:var(--bg-surface); color:var(--text-primary); cursor:pointer; font-size:14px; display:flex; align-items:center; justify-content:center;\" onmouseover=\"this.style.background='var(--primary)'; this.style.color='#fff';\" onmouseout=\"this.style.background='var(--bg-surface)'; this.style.color='var(--text-primary)';\" onclick=\"const el = document.getElementById('inDemo2'); el.value = (parseFloat(el.value || 0) + 0.25).toFixed(2);\">\n          <i class=\"fa-solid fa-plus\"></i>\n        </button>\n      </div>\n    ",
        "code": "# GDScript: 精度与步长\nnum_input.value = 1.50\nnum_input.step = 0.25\nnum_input.precision = 2"
      },
      {
        "title": "3. 范围上下限严格限制 (Strict Range: 10 ~ 100)",
        "render": "\n      <div style=\"display:flex; align-items:center; gap:12px;\">\n        <div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:6px; background:var(--bg-surface); overflow:hidden;\">\n          <button style=\"width:36px; height:36px; border:none; background:var(--bg-surface); color:var(--text-primary); cursor:pointer;\" onclick=\"const el = document.getElementById('inDemo3'); el.value = Math.max(10, parseInt(el.value || 50) - 10);\">\n            <i class=\"fa-solid fa-minus\"></i>\n          </button>\n          <input type=\"text\" id=\"inDemo3\" value=\"50\" style=\"width:60px; height:36px; border:none; border-left:1px solid var(--border-base); border-right:1px solid var(--border-base); text-align:center; background:var(--bg-card); color:var(--text-primary); font-size:14px; font-weight:600; outline:none;\" onchange=\"this.value = Math.max(10, Math.min(100, parseInt(this.value)||10))\">\n          <button style=\"width:36px; height:36px; border:none; background:var(--bg-surface); color:var(--text-primary); cursor:pointer;\" onclick=\"const el = document.getElementById('inDemo3'); el.value = Math.min(100, parseInt(el.value || 50) + 10);\">\n            <i class=\"fa-solid fa-plus\"></i>\n          </button>\n        </div>\n        <span style=\"font-size:12px; color:var(--text-secondary);\">范围限定: [10, 100]，步长 10</span>\n      </div>\n    ",
        "code": "# GDScript: 严格范围约束\nnum_input.min_value = 10\nnum_input.max_value = 100\nnum_input.step = 10"
      },
      {
        "title": "4. 控制按钮位置 (Controls Position: 右侧上下堆叠式 vs 左右两侧式)",
        "render": "\n      <div style=\"display:flex; gap:20px; align-items:center; flex-wrap:wrap;\">\n        <!-- Right Stacked Controls -->\n        <div style=\"display:inline-flex; border:1px solid var(--border-base); border-radius:6px; background:var(--bg-card); overflow:hidden;\">\n          <input type=\"text\" id=\"inDemo4\" value=\"8\" style=\"width:60px; height:36px; border:none; text-align:center; background:transparent; color:var(--text-primary); font-size:14px; font-weight:600; outline:none;\">\n          <div style=\"display:flex; flex-direction:column; border-left:1px solid var(--border-base); width:26px;\">\n            <button style=\"flex:1; border:none; background:var(--bg-surface); color:var(--text-secondary); cursor:pointer; font-size:10px; display:flex; align-items:center; justify-content:center; border-bottom:1px solid var(--border-base);\" onclick=\"const el=document.getElementById('inDemo4'); el.value=parseInt(el.value||0)+1;\">\n              <i class=\"fa-solid fa-chevron-up\"></i>\n            </button>\n            <button style=\"flex:1; border:none; background:var(--bg-surface); color:var(--text-secondary); cursor:pointer; font-size:10px; display:flex; align-items:center; justify-content:center;\" onclick=\"const el=document.getElementById('inDemo4'); el.value=Math.max(0, parseInt(el.value||0)-1);\">\n              <i class=\"fa-solid fa-chevron-down\"></i>\n            </button>\n          </div>\n        </div>\n        <span style=\"font-size:12px; color:var(--text-secondary);\">右侧上下堆叠 (Controls.RIGHT)</span>\n      </div>\n    ",
        "code": "# GDScript: 控制按钮靠右堆叠\nnum_input.controls_position = GInputNumber.Controls.RIGHT"
      },
      {
        "title": "5. 禁用与只读状态 (Disabled & Readonly)",
        "render": "\n      <div style=\"display:flex; gap:16px; align-items:center;\">\n        <div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:6px; background:var(--bg-surface); overflow:hidden; opacity:0.5;\">\n          <button style=\"width:36px; height:36px; border:none; background:var(--bg-surface); color:var(--text-secondary); cursor:not-allowed;\" disabled>-</button>\n          <input type=\"text\" value=\"99\" disabled style=\"width:60px; height:36px; border:none; border-left:1px solid var(--border-base); border-right:1px solid var(--border-base); text-align:center; background:var(--bg-card); color:var(--text-secondary); cursor:not-allowed;\">\n          <button style=\"width:36px; height:36px; border:none; background:var(--bg-surface); color:var(--text-secondary); cursor:not-allowed;\" disabled>+</button>\n        </div>\n        <span style=\"font-size:12px; color:var(--text-secondary);\">已禁用状态 (Disabled)</span>\n      </div>\n    ",
        "code": "# GDScript: 禁用状态\nnum_input.disabled = true"
      },
      {
        "title": "6. 游戏自由加点属性分配器 (RPG Stat Points Allocator)",
        "render": "\n      <div style=\"max-width:340px; background:var(--bg-surface); padding:14px; border-radius:8px; border:1px solid var(--border-base); display:flex; flex-direction:column; gap:10px;\">\n        <div style=\"display:flex; justify-content:space-between; font-size:13px; border-bottom:1px solid var(--border-base); padding-bottom:8px;\">\n          <span>剩余潜能点:</span>\n          <strong style=\"color:var(--primary); font-size:14px;\" id=\"statRemain\">15 点</strong>\n        </div>\n        <div style=\"display:flex; justify-content:space-between; align-items:center; font-size:13px;\">\n          <span>💪 力量属性 (STR):</span>\n          <div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:4px; overflow:hidden; background:var(--bg-card);\">\n            <button class=\"g-btn g-btn-default\" style=\"width:28px; height:28px; padding:0; border:none; border-radius:0;\" onclick=\"\n              const val = document.getElementById('statStr');\n              const rem = document.getElementById('statRemain');\n              let cur = parseInt(val.innerText);\n              let curRem = parseInt(rem.innerText);\n              if (cur > 20) {\n                val.innerText = cur - 1;\n                rem.innerText = (curRem + 1) + ' 点';\n              }\n            \">-</button>\n            <span id=\"statStr\" style=\"width:36px; text-align:center; font-weight:700; font-size:13px;\">28</span>\n            <button class=\"g-btn g-btn-primary\" style=\"width:28px; height:28px; padding:0; border:none; border-radius:0;\" onclick=\"\n              const val = document.getElementById('statStr');\n              const rem = document.getElementById('statRemain');\n              let cur = parseInt(val.innerText);\n              let curRem = parseInt(rem.innerText);\n              if (curRem > 0) {\n                val.innerText = cur + 1;\n                rem.innerText = (curRem - 1) + ' 点';\n              }\n            \">+</button>\n          </div>\n        </div>\n      </div>\n    ",
        "code": "# GDScript: 游戏加点分配器\nvar stat_alloc = GInputNumber.new_stat_point(\"力量\", 28, 15)"
      }
    ],
    "props": [
      {
  ...
  "stepper": {
    ...
    "demos": [
      {
        "title": "1. 基础移动端步进器 (Basic Stepper)",
        "render": "<div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:4px; overflow:hidden;\"><button style=\"border:none; background:var(--bg-surface); padding:6px 14px; cursor:pointer; color:var(--text-primary);\">-</button><input type=\"text\" value=\"1\" readonly style=\"width:40px; border:none; text-align:center; background:var(--bg-card); color:var(--text-primary);\"><button style=\"border:none; background:var(--bg-surface); padding:6px 14px; cursor:pointer; color:var(--text-primary);\">+</button></div>",
        "code": "# GDScript: 基础步进器\nvar stepper = GStepper.new()\nstepper.value = 1\nadd_child(stepper)"
      },
      {
        "title": "2. 步长与最大购买量限制 (Step & Max Buy Limit)",
        "render": "<div style=\"display:flex; align-items:center; gap:10px;\"><div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:4px; overflow:hidden;\"><button style=\"border:none; background:var(--bg-surface); padding:6px 14px; cursor:pointer;\">-</button><input type=\"text\" value=\"10\" readonly style=\"width:40px; border:none; text-align:center; background:var(--bg-card); color:var(--text-primary);\"><button style=\"border:none; background:var(--bg-surface); padding:6px 14px; cursor:pointer;\">+</button></div><span style=\"font-size:12px; color:var(--text-secondary);\">步长 5，上限 50</span></div>",
        "code": "# GDScript: 步长上限\nstepper.step = 5\nstepper.max = 50"
      },
      {
        "title": "3. 禁用与只读状态 (Disabled & Readonly)",
        "render": "<div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:4px; overflow:hidden; opacity:0.5;\"><button style=\"border:none; background:var(--bg-surface); padding:6px 14px; cursor:not-allowed;\" disabled>-</button><input type=\"text\" value=\"0\" readonly style=\"width:40px; border:none; text-align:center; background:var(--bg-card); color:var(--text-primary);\"><button style=\"border:none; background:var(--bg-surface); padding:6px 14px; cursor:not-allowed;\" disabled>+</button></div>",
        "code": "# GDScript: 禁用\nstepper.disabled = true"
      },
      {
        "title": "4. 圆形胶囊形态 (Round Capsule Stepper)",
        "render": "<div style=\"display:inline-flex; align-items:center; gap:8px;\"><button class=\"g-btn g-btn-primary\" style=\"width:28px; height:28px; border-radius:50%; padding:0; display:flex; align-items:center; justify-content:center;\">-</button><span style=\"font-weight:600; font-size:14px; min-width:24px; text-align:center;\">3</span><button class=\"g-btn g-btn-primary\" style=\"width:28px; height:28px; border-radius:50%; padding:0; display:flex; align-items:center; justify-content:center;\">+</button></div>",
        "code": "# GDScript: 胶囊圆角\nstepper.round = true"
      },
      {
        "title": "5. 游戏商店批量购买药水实战 (Game Batch Item Purchase)",
        "render": "<div style=\"max-width:340px; background:var(--bg-surface); padding:12px; border-radius:8px; border:1px solid var(--border-base); display:flex; justify-content:space-between; align-items:center;\"><div style=\"font-size:13px;\"><div style=\"font-weight:600;\">🧪 特级生命药水</div><div style=\"font-size:11px; color:#e6a23c;\">单价: 50 🪙</div></div><div style=\"display:inline-flex; align-items:center; border:1px solid var(--border-base); border-radius:4px; overflow:hidden;\"><button style=\"border:none; background:var(--bg-card); padding:4px 10px;\">-</button><span style=\"padding:0 8px; font-size:13px; font-weight:700;\">5</span><button style=\"border:none; background:var(--bg-card); padding:4px 10px;\">+</button></div></div>",
        "code": "# GDScript: 商店批量购买\nvar shop_stepper = GStepper.new_shop_item(\"potion\", 50)"
      }
    ],
    "props": [
      {
