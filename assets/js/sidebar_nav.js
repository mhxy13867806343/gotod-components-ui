    ...
    groups: [
      {
        ...
        items: [
          ...
          { key: 'game-memory-speedrun', title: '🏁 竞速：极速记忆挑战' },
          { key: 'game-memory-boss', title: '🐉 Boss：巨龙记忆战' },
          { key: 'game-memory-story', title: '📖 剧情：记忆王国冒险' },
          { key: 'game-memory-puzzle', title: '🧩 解谜：机关卡牌迷阵' },
          { key: 'game-memory-collection', title: '🎁 收集：卡牌图鉴与成就' },
          { key: 'game-memory-daily', title: '📅 日常：每日随机挑战' },
          { key: 'game-memory-tournament', title: '🏆 赛事：淘汰赛记忆杯' },
          { key: 'game-memory-accessibility', title: '♿ 无障碍：辅助记忆模式' },
          { key: 'game-memory-replay', title: '🎬 回放：对局录像分析' },
          { key: 'game-memory-analytics', title: '📊 数据：玩家行为分析' },
